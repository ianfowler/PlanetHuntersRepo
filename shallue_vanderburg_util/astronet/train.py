...
from shallue_vanderburg_util.astronet import models
from shallue_vanderburg_util.astronet.util import estimator_util
from shallue_vanderburg_util.tf_util import config_util
from shallue_vanderburg_util.tf_util import configdict
from shallue_vanderburg_util.tf_util import estimator_runner
...
def train(exohome, train_steps, typ="traditional"):
    ...
    config = (models.get_model_config(MODEL, CONFIG_NAME))
