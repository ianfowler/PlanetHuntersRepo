...
def generic_transit_model(time, orbital_period, orbital_radius, planet_radius, u1=0.4, u2=0.25, t0=0.0):
  """Evaluates a transit model assuming quadratic limb darkening."""
  params = generic_transit_params(t0, orbital_period, orbital_radius, planet_radius, "quadratic", [u1, u2])
  
  duration = compute_duration(orbital_period, planet_radius, orbital_radius, 90.0)
  return transit_model(time, params), duration
