...
import pickle
from simulated_transits.transit_model import generic_transit_model, compute_duration
STELLAR_RADIUS = 6.957*(10**8)

def setup():
    t_bins = bins(100, 100)
    with open('Resources/temperature_bins.obj', 'wb') as f:
        pickle.dump(t_bins, f)

with open('Resources/temperature_bins.obj', 'rb') as f:
...
#    print(duration, samples)
    ...
    flux, duration = generic_transit_model(t, orbital_period, orbital_radius, planet_radius, t0=t0)
    return flux, orbital_period, duration
